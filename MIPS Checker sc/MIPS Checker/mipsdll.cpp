...
MYDLL_API BSTR by_dir_func(LPSTR programDIR, LPSTR formulaDIR){
	...
	linkNodes(root);
	openFile(formulaToCheck,&numFormula,formulaDIR);
...
MYDLL_API BSTR manually_func(LPSTR programDIR, HAD had, int nIndex){
