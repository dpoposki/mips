...
string codeToRegister(int code){

	if(code == 0) return (string)"v0";
	if(code == 1) return (string)"v1";
	if(code == 2) return (string)"a0";
	if(code == 3) return (string)"a1";
	if(code == 4) return (string)"a2";
	if(code == 5) return (string)"a3";
	if(code == 6) return (string)"t0";
	if(code == 7) return (string)"t1";
	if(code == 8) return (string)"t2";
	if(code == 9) return (string)"t3";
	if(code == 10) return (string)"t4";
	if(code == 11) return (string)"t5";
	if(code == 12) return (string)"t6";
	if(code == 13) return (string)"t7";
	if(code == 14) return (string)"t8";
	if(code == 15) return (string)"t9";
	if(code == 16) return (string)"s0";
	if(code == 17) return (string)"s1";
	if(code == 18) return (string)"s2";
	if(code == 19) return (string)"s3";
	if(code == 20) return (string)"s4";
	if(code == 21) return (string)"s5";
	if(code == 22) return (string)"s6";
	if(code == 23) return (string)"s7";
	if(code == 24) return (string)"fp";
	if(code == 25) return (string)"gp";
	if(code == 26) return (string)"lo";
	if(code == 27) return (string)"hi";
